...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--surface-border)] bg-[var(--surface-card)]/50">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-6xl py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Community */}
          <div>
            <h4 className="font-semibold text-white mb-4">{t("community.title")}</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <NextLink href={`/${locale}/about`} className="text-surface-muted hover:text-white transition-colors">
                  {t("company.about")}
                </NextLink>
              </li>
              <li>

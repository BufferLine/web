...
const layers = [
  ...
  {
    key: "personaforge",
    accentText: "text-accent-personaforge",
    accentBg: "bg-accent-personaforge/10",
    accentBorder: "border-accent-personaforge/20",
    accentDot: "bg-accent-personaforge",
    hoverText: "group-hover:text-accent-personaforge-light",
    href: "/personaforge",
  },
  {
    key: "metagovernance",

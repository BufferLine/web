            ...
            <NextLink href={`/${locale}/deck/general`} passHref>
              ...
              >
                <div className="flex-grow">
                  ...
                  <h4 className="text-lg font-semibold text-white mb-2 transition-colors group-hover:text-accent-bufferline-light">
                ...
                <div className="mt-4 flex items-center text-sm font-medium text-neutral-500 transition-colors group-hover:text-accent-bufferline-light">
                  {t("cta")}
            ...
            <NextLink href={`/${locale}/deck`} passHref>
              ...
              >
                <div className="flex-grow">
                  ...
                  <h4 className="text-lg font-semibold text-white mb-2 transition-colors group-hover:text-accent-jdvp-light">
                    {t("more.title")}
                  </h4>
                  <p className="text-surface-muted text-sm leading-relaxed">
                    {t("more.description")}

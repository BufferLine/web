      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-4 sm:mb-8">
          <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4 text-neutral-300 font-mono text-sm md:text-base">
            <div className="p-3 md:p-4 border border-surface-border rounded-lg bg-surface-card/75">Observer</div>
            <div className="text-teal-400">→</div>
            <div className="p-3 md:p-4 border border-surface-border rounded-lg bg-surface-card/75">Analyzer</div>
            <div className="text-teal-400">→</div>
            <div className="p-3 md:p-4 border border-surface-border rounded-lg bg-surface-card/75">Reporter</div>
          </div>
        </div>
